...
import { Websocket as WebsocketAPI, WebsocketConnection } from './websocket';

export const ErrConnectionNotInitialized = new Error('Connection not intialized');
export const WebsocketConnectionContext = React.createContext<WebsocketConnection | Error>(ErrConnectionNotInitialized);
